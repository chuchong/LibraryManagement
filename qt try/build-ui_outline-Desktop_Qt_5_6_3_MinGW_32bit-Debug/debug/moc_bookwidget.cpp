...
#include "D:/qt big/qt try/ui_outline/bookwidget.h"
...
const QMetaObject BookWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BookWidget.data,
      qt_meta_data_BookWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BookWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BookWidget.stringdata0))
        return static_cast<void*>(const_cast< BookWidget*>(this));
